	  ...
	  <div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
		  ...
		  <div class="navbar-header">
			...
			<a href="#top" class="navbar-brand navbar-brand-height smoothScroll"><img src="images/TEDxlogob.svg" style="height: 50px;"></a>
		  </div>
			<div class="collapse navbar-collapse">
			  <ul class="nav navbar-nav navbar-right">
				...
				<li id="liteam" class="dropdown">
					<a href="team2019.html" class="dropbtn ">Team</a>
					<div class="dropdown-content">
				...
				<li id="sponserteam" class="dropdown">
					<a href="javascript:void(0)" class="dropbtn ">Sponsers</a>
					<div class="dropdown-content">
					  <a href="comingsoon.html">2018</a>
					  <a href="comingsoon.html">2017</a>
	...
	<section id="register">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 wow fadeInUp sociopad" data-wow-delay="0.2s">				
					<p class="paragraph">Do you have an inspiring idea or an exciting project that you work on? Do you think your passion can captivate the audience and spark discussions?</p>
					<p class="paragraph">If you think you have a story worth sharing, we at TEDxSomaiyaVidyavihar are committed to provide you the platform for that.</p>
					<p class="paragraph">If you know someone who belongs on the TEDx stage, or if you belong there yourself, we want to hear from you! Please use our speaker recommendation form to tell us why this person would be well-suited to speak at TEDxSomaiyaVidyavihar.</p>
					<a class="smoothScroll btn btn-success btn-lg wow fadeInUp animated" href="https://goo.gl/forms/KGPi07GgYilhl9p53" target="_blank" >Nominate a Speaker</a>
				</div>	  
			</div>
		</div>
	</section>
